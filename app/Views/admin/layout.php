    ...
    <div class="d-flex">
        ...
        <div class="sidebar d-flex flex-column px-2 py-3 text-white">
            ...
            <ul class="nav nav-pills flex-column mb-auto mt-3">
                ...
                <li>
                    <a href="<?= base_url('admin/peminjaman') ?>" class="nav-link <?= (uri_string() == 'admin/peminjaman' && !strpos($_SERVER['QUERY_STRING'] ?? '', 'status_id=2')) ? 'active' : '' ?>">
                ...
                <li>
                    <a href="<?= base_url('admin/maintenance/schedules') ?>" class="nav-link <?= strpos(uri_string(), 'admin/maintenance/schedules') !== false ? 'active' : '' ?>">
                        <i class="bi bi-calendar-event me-2"></i> Jadwal Maintenance
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('admin/maintenance/records') ?>" class="nav-link <?= strpos(uri_string(), 'admin/maintenance/records') !== false ? 'active' : '' ?>">
