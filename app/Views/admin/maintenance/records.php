...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        <form action="<?= base_url('admin/maintenance/records') ?>" method="get" class="row g-2 align-items-center">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if(empty($records)): ?>
                        <tr><td colspan="6" class="text-center py-4 text-muted">Belum ada riwayat maintenance.</td></tr>
                    <?php else: ?>
