...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body">
        <form action="<?= base_url('admin/pengaduan') ?>" method="get" class="row g-3">
            <input type="hidden" name="show_deleted" value="<?= isset($showDeleted) ? ($showDeleted ? '1' : '') : '' ?>">
            <div class="col-md-4">
            ...
            <div class="col-md-4 d-flex align-items-end gap-2">
                ...
                <a href="<?= base_url('admin/pengaduan' . (isset($showDeleted) && $showDeleted ? '?show_deleted=1' : '')) ?>" class="btn btn-sm btn-outline-secondary px-3 shadow-none">
                    Reset
                </a>
            </div>
        </form>
...
<div class="modal fade" id="updateModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/pengaduan/update_status') ?>" method="post" class="form-confirm">
