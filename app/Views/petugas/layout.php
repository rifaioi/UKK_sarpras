...
<body>
    <div class="d-flex">
        ...
        <div class="sidebar d-flex flex-column px-2 py-3 text-white" style="width: 210px;">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none border-bottom border-light pb-3 w-100">
            ...
            <ul class="nav nav-pills flex-column mb-auto mt-3">
                ...
                <li>
                    <a href="<?= base_url('petugas/peminjaman') ?>" class="nav-link <?= strpos(uri_string(), 'petugas/peminjaman') !== false ? 'active' : '' ?>">
                        <i class="bi bi-inbox-fill me-2"></i> Persetujuan Pinjam
                    </a>
                </li>
                <li>
                    <a href="<?= base_url('petugas/pengembalian') ?>" class="nav-link <?= strpos(uri_string(), 'petugas/pengembalian') !== false ? 'active' : '' ?>">
