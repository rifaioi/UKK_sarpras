...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('petugas/profile/update') ?>" method="post" class="form-confirm">
                    <?= csrf_field() ?>
                    <div class="mb-3">
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('petugas/profile/update_password') ?>" method="post" id="passwordForm" class="form-confirm">
                    <?= csrf_field() ?>
                    <div class="mb-3">
