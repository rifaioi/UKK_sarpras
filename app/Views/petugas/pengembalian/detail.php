...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<?= base_url('petugas/pengembalian/riwayat') ?>">Riwayat</a></li>
...
<div class="row mb-3">
    <div class="col-md-8">
        <h2><i class="bi bi-arrow-left-right me-2 text-primary"></i>Perbandingan Kondisi Alat</h2>
        <p class="text-muted">Membandingkan kondisi barang saat keluar (peminjaman) vs saat kembali.</p>
    </div>
    <div class="col-md-4 text-end">
        <a href="<?= base_url('petugas/pengembalian/riwayat') ?>" class="btn btn-secondary">
            ...
            <div class="card-body bg-light rounded shadow-sm">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 border-end ps-4">
                        <small class="text-muted d-block text-uppercase fw-bold" style="font-size: 0.7rem;">Timeline</small>
                    ...
                    <div class="col-md-4 ps-4">
                        <small class="text-muted d-block text-uppercase fw-bold" style="font-size: 0.7rem;">Status Akhir</small>
                        <?php 
